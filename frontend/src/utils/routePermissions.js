...
export const ROUTE_PERMISSION_RULES = [
    ...
    rule(/^\/finance\/monthly$/, 'finance.invoices.view'),
    rule(/^\/finance\/students\/[^/]+$/, 'finance.invoices.view'),
    rule(/^\/finance\/payments$/, 'finance.payments.view'),
    rule(/^\/finance\/salary-approvals$/, 'finance.compensation.view'),
    rule(/^\/finance\/payroll-approvals$/, 'payroll.view'),
    rule(/^\/finance\/reports$/, 'finance.reports.view'),
    rule(/^\/finance\/outstanding$/, 'finance.outstanding.view'),

    rule(/^\/hr$/, 'hr.dashboard.view'),
    rule(/^\/hr\/employees$/, 'hr.employees.view'),
    rule(/^\/hr\/leaves$/, 'hr.leaves.review'),
    rule(/^\/hr\/payroll$/, 'payroll.view'),
    rule(/^\/hr\/reports$/, 'payroll.view'),

    rule(/^\/branch$/, 'branch.dashboard.view'),
    rule(/^\/branch\/classes$/, 'branch.classes.view'),
    rule(/^\/branch\/staff\/new$/, 'branch.staff.create'),
    rule(/^\/branch\/teachers\/new$/, 'branch.staff.create'),
    rule(/^\/branch\/staff$/, 'branch.staff.view'),
    rule(/^\/branch\/teachers$/, 'branch.staff.view'),
    rule(/^\/branch\/students$/, 'branch.students.view'),
    rule(/^\/branch\/students\/[^/]+$/, 'branch.students.detail'),
    rule(/^\/branch\/promotions$/, 'branch.promotions.run'),
    rule(/^\/branch\/transfers$/, 'branch.transfers.run'),
    ...
    rule(/^\/cashier\/salary-payments$/, 'payroll.pay'),
